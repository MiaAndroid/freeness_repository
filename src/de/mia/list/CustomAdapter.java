...
public class CustomAdapter extends BaseAdapter implements OnClickListener {
         ...
         public View getView(int position, View convertView, ViewGroup parent) {
             ...
             else
             {
                 ...
                 /************  Set Model values in Holder elements ***********/
                  ...
                  holder.text.setText( tempValues.getEntfernung());
                  holder.text1.setText( tempValues.getName());
                  holder.text2.setText( tempValues.getLevel());
                 
                  int img = res.getIdentifier(tempValues.getImage(), "drawable", activity.getPackageName());
         ...
         /********* Called when Image click in ListView ************/
